...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 hover:scale-105",
  {
    variants: {
      variant: {
        ...
        ai: "border-transparent bg-ai text-ai-foreground hover:bg-ai/80 hover:shadow-sm ai-glow",
      },
    },
    defaultVariants: {
      variant: "default",
